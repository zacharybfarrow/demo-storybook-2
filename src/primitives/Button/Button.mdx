...
**Specifies the `rounded` border radius Button element that is rendered**

- `"SQUARE"` - renders the button with a squared border containing a value of `border-radius: 0px;`
- `"SMALL"` - renders the button with a round border containing a value of `border-radius: 0.375rem;`
- `"MEDIUM"` - renders the button with a round border containing a value of `border-radius: 0.5rem;`
- `"LARGE"` - renders the button with a round border containing a value of `border-radius: 0.75rem;`
- `"XLARGE"` - renders the button with a round border containing a value of `border-radius: 1rem;`
- `"CIRCLE"` - renders the button with a round border containing a value of `border-radius: 9999px;`
