...
const SvgE1XIcoFont67 = (
  ...
  <svg
    ...
    id="E1X_ico_font-67_svg__Layer_1"
    data-name="Layer 1"
    viewBox="0 0 24 24"
    width={props.width}
    height={props.height}
  ...
  >
    ...
    <defs>
      <clipPath id="E1X_ico_font-67_svg__clip-path">
        <path
          d="M0 0h24v24H0z"
          style={{
            fill: "none",
      ...
      <style>
        {
          ".E1X_ico_font-67_svg__cls-2{clip-path:url(#E1X_ico_font-67_svg__clip-path)}"
        }
      </style>
    </defs>
    <g
      id="E1X_ico_font-67_svg__ico_print_0"
      className="E1X_ico_font-67_svg__cls-2"
    >
      <path
